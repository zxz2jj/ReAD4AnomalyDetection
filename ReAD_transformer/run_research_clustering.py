...
from ReAD import get_neural_value, statistic_of_neural_value, \
    encode_abstraction, concatenate_data_between_layers, statistic_distance, auroc, sk_auc
...
if __name__ == "__main__":
    ...
    for attack in attacks:
        ...
        if (not os.path.exists(f'./data/{id_dataset}/cluster_research/test_ReAD_Clean_{attack}.pkl') and
            ...
            clean_ReAD_abstractions = encode_abstraction(id_dataset=id_dataset,
                                                         neural_value=clean_picture_neural_value,
                                                         train_dataset_statistic=train_nv_statistic)
            print('\nEncoding ReAD abstraction of ADVERSARIAL data:')
            adv_ReAD_abstractions = encode_abstraction(id_dataset=id_dataset, neural_value=adv_picture_neural_value,
                                                       train_dataset_statistic=train_nv_statistic)
